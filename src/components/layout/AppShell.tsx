...
import { StockApiPreview } from "@/components/stocks/StockApiPreview";
  ...
  return (
    <div className="grid min-h-dvh grid-cols-1 grid-rows-[56px_minmax(0,1fr)] bg-page md:grid-cols-[252px_minmax(0,1fr)_360px]">
      ...
      >
        ...
        <StockApiPreview ticker={selectedTicker} />
...
<FinancialsPage selectedTicker={selectedTicker} />
) : null}
        {activeModule === "valuation" ? (
  <ValuationPage selectedTicker={selectedTicker} />
) : null}
        {activeModule === "technical" ? (
  <TechnicalPage selectedTicker={selectedTicker} />
) : null}
        {activeModule === "risk" ? (
  <RiskPage selectedTicker={selectedTicker} />
) : null}
      </MainContent>
      <RightAssistantPanel
        activeLabel={activeItem.label}
