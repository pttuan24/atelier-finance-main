...
import { RealFinancialsSummary } from "@/components/stocks/RealFinancialsSummary";
import { RealValuationSummary } from "@/components/stocks/RealValuationSummary";

type FinancialsPageProps = {
  selectedTicker?: string;
};

export function FinancialsPage({ selectedTicker = "VCB" }: FinancialsPageProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-[980px] space-y-6">
      <RealFinancialsSummary ticker={selectedTicker} />
