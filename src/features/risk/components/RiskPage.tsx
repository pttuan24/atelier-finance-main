...
import { RealRiskSummary } from "@/components/stocks/RealRiskSummary";

type RiskPageProps = {
  selectedTicker?: string;
};

export function RiskPage({ selectedTicker = "VCB" }: RiskPageProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-[980px] space-y-6">
      <RealRiskSummary ticker={selectedTicker} />
